...
<html xmlns="http://www.w3.org/1999/xhtml"  xmlns:v="urn:schemas-microsoft-com:vml">
    <head>
        ...
        <!-- this given Google API key have to change according the live site -->
        <script src=" http://maps.google.com/?file=api&amp;v=2&amp;key=ABQIAAAAjQzDnaKmPEyJWLisfJ5PRhR5IRvhvyJ2qnElMEFFLiD9tNq5EBQLuY1LpHXhxIFz3d2B68dDPe2QgQ" type="text/javascript"></script>
		<style type="text/css">
            body {
        ...
        <script type="text/javascript">
			...
			function initialize() {
				if (GBrowserIsCompatible()) {      
					...
					setDirections("Bashundhara, Dhaka", "Shyamoli, Dhaka", "en_US");
				}
			}
			...
			function onGDirectionsLoad(){ 
				...
				params.push("key=ABQIAAAAjQzDnaKmPEyJWLisfJ5PRhR5IRvhvyJ2qnElMEFFLiD9tNq5EBQLuY1LpHXhxIFz3d2B68dDPe2QgQ");
        ...
        <form action="#" onsubmit="setDirections(this.from.value, this.to.value, this.locale.value); return false">
            <table>
                <tr>
                    ...
                    <td align="right"><input type="text" size="25" id="toAddress" name="to" value="Shyamoli, Dhaka" /></td></tr>
                    
                    <tr><!--th>Language:&nbsp;</th-->
                    <td colspan="3">
                        <select style="display:none;" id="locale" name="locale">
